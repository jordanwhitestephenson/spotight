...
const GlobalStyle = createGlobalStyle`
      ...
      .scrollspy__menu {
        ...
        li {
          ...
          a {
            ...
            transition: all 0.3s ease;
            &:hover {
              color: ${themeGet('colors.primary', '#0ba0e9')};
            }
          }
          &.is-current {
            a {
              ...
              &:before {
                ...
                height: 8px;
                border-radius: 50%;
                background-color: ${themeGet('colors.primary', '#0ba0e9')};
                position: absolute;
                top: calc(50% - 8px / 2);
                left: -20px;
              }
  ...
  button.modalCloseBtn {
    ...
    &.alt {
      background-color: ${themeGet('colors.primary', '#0ba0e9')} !important;
...
const AgencyWrapper = styled.div`
  ...
  .reusecore__navbar {
    ...
    transition: all 0.3s ease;
    .reusecore__button {
      color: ${themeGet('colors.white', '#08a0e9')};
      font-size: 18px;
      @media only screen and (max-width: 480px) {
        color: ${themeGet('colors.primary', '#0ba0e9')};
      }
    ...
    .hamburgMenu__bar {
      margin-left: 8px;
      > span {
        background-color: ${themeGet('colors.white', '#08a0e9')};
        @media only screen and (max-width: 480px) {
          background-color: ${themeGet('colors.primary', '#0ba0e9')};
        }
      }
