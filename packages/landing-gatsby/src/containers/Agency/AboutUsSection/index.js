...
const AboutUsSection = ({
  ...
  const Data = useStaticQuery(graphql`
    query {
      image1: file(
        relativePath: { eq: "image/agency/group/P287_BASF_New Energy_Tires.jpg" }
      ) {
        childImageSharp {
          gatsbyImageData(
            layout: FULL_WIDTH
      ...
      image2: file(
        relativePath: { eq: "image/agency/group/web1_TTL061216tirerecycling-hanover_1.jpg.webp" }
      ) {
        childImageSharp {
          gatsbyImageData(
            layout: FULL_WIDTH
      ...
      image3: file(
        relativePath: { eq: "image/agency/group/Workforce.png" }
      ) {
        childImageSharp {
          gatsbyImageData(
            layout: FULL_WIDTH
  ...
  return (
    <AboutUsSectionWrapper id="ResponsibilitySection">
        ...
        <Box className="col" {...col}>
          <Box {...textArea}>
            <FeatureBlock
              ...
              description={
                <Text
                  content="For Spotlight, social responsibility is at the heart of everything we do"
                  {...description}
                />
              }
            />
