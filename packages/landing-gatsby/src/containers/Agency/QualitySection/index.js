...
const QualitySection = ({
  ...
  const Data = useStaticQuery(graphql`
    query {
      ...
      image: file(relativePath: { eq: "image/agency/team/JoinTheTeam.png" }) {
        childImageSharp {
          gatsbyImageData(
            layout: FULL_WIDTH
            placeholder: BLURRED
  ...
  return (
    <QualitySectionWrapper id="CareersSection">
      <Container>
        <Box className="row" {...row}>
          <Box className="col" {...col} {...textArea}>
            <FeatureBlock
              ...
              description={
                <Text
                  content="We're proud of where we've been and where we're going. Our blend of passion and  technological innovation is the force behind our growth."
                  {...description}
                />
              }
            />
